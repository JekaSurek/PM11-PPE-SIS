...
--Добавление ролей (первая таблица без внешних ключей)
INSERT INTO [Роль] ([Наименование], [Описание])
VALUES 
('Администратор', 'Полный доступ ко всем функциям системы'),
('Менеджер СИЗ', 'Основной пользователь системы учета СИЗ'),
('Начальник цеха', 'Контроль за обеспечением СИЗ в подразделении'),
('Специалист по ОТ', 'Контроль соблюдения норм выдачи СИЗ'),
('Кладовщик', 'Учет и хранение СИЗ на складе'),
('Бухгалтер', 'Учет финансовых операций по СИЗ');
GO

--Добавление инфраструктуры (нет внешних ключей)
...
--Добавление сезонов (нет внешних ключей)
...
--Добавление типов СИЗ (нет внешних ключей)
